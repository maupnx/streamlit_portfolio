...
with st.expander("Referral Links"):
    ...
    st.markdown("[Go to Content](https://www.meioemensagem.com.br/home/midia/2020/07/09/estadao-aposta-em-gamificacao-para-engajar-estudantes.html)")
    st.markdown("[Go to Content](https://www.meioemensagem.com.br/home/midia/2020/07/09/estadao-aposta-em-gamificacao-para-engajar-estudantes.html)")
    st.write("")
    st.write("")
    st.write("Case - Performance Room Stellantis")
    st.markdown("[Go to Content](https://www.dp6.com.br/cases/case-sala-de-performance-fca/)")
    st.write("")
    st.write("")
    st.write("Podcast - Unique Audience Management - Discovering Salesforce Interaction Studio")
    st.markdown("[Go to Podcast](https://open.spotify.com/episode/5fQRNAjL18neexxiKfiHCg)")
    st.write("")
    st.write("")
    st.write("Ecommerce Brazil - Performance Rooms")
    st.markdown("[Go to Content](https://www.ecommercebrasil.com.br/artigos/sala-de-performance/)")
    st.write("")
    st.write("")
    st.write("IAB Brazil - Media Performance Guide")
    st.markdown("[Go to Content](https://silo.tips/download/objetivo-do-documento/)")
